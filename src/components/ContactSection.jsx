...
export const ContactSection = () => {
    return <section id="contact" className="py-24 px-4 relative bg-secondary/30">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">Get In <span className="text-primary"></span>Touch</h2>
            ...
            <div className="space-y-8 ">
                ...
                <div className="pt-8">
                    ...
                    <div className="flex space-x-4 justify-center">
                        <a href="https://www.linkedin.com/in/hamza-rafi-46053a286/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors">
                            <Linkedin/>
                        </a>
                    </div>
                </div>
