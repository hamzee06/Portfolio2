...
export const Navbar = () => {
    ...
    return (
    <nav className={cn(
        "fixed w-full z-40 transiotion-all duration-300",
    ...
    <div className="container flex items-center justify-between">
        ...
        <div className={cn("fixed inset-0 bg-background/95 backdroup-blur-md flex flex-col items-center justify-center",
